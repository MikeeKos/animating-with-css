...
function WhatsAnimation() {
  ...
  return (
    <React.Fragment>
      ...
      <div className="overflow-hidden w-full h-[34rem] bg-page1 shadow-[inset_0_-8px_16px_rgba(0,0,0,0.2)] border-2 border-page4 flex items-center justify-center relative">
        ...
        <pre className="language-css">
          <code className="language-css">
            {`
.container {
  animation: slide-around 1s ease-in-out forwards 3 alternate 250ms;
}
